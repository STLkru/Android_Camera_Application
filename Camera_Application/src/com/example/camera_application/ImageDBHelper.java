...
import com.example.camera_application.ImageContract.FeedEntry;
...
public class ImageDBHelper extends SQLiteOpenHelper {
	...
	private static final String SQL_CREATE_ENTRIES =
	    ...
	    FeedEntry.COLUMN_NAME_FILENAME + TEXT_TYPE + COMMA_SEP +
	    FeedEntry.COLUMN_NAME_DESCRIPTION + TEXT_TYPE + COMMA_SEP +
	    FeedEntry.COLUMN_NAME_TIMESTAMP + TEXT_TYPE + COMMA_SEP +
